...
Before submission, decide the final author list, affiliations, acknowledgements/tooling disclosure, target venue style, and whether to include the rank-22 campaign once it has a stable result.
