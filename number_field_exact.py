...
def discover_common_field(unresolved, *, max_degree=10, tol=None, maxcoeff_algdep=10**30,
                          maxcoeff_basis=10**40, pair_sample=12, individual_sample=32):
    ...
    if tol is None:
        tol = mp.mpf(10) ** (-(mp.mp.dps - 30))
    diagnostics = {"individual": [], "candidates": []}
